...
|ContentShape|ositrace|<a id="prop-https---w3id-org-ascs-ev-envited-x-ositrace-v6-lanetypes"></a>laneTypes|||Covered lane types. Complete ASAM OpenDRIVE e_laneType enumeration (31 values) as defined in imports/OpenDrive/xsd_schema/OpenDRIVE_Lane.xsd (ASAM OpenDRIVE V1.8.0) and specified in ASAM OpenDRIVE v1.9.0 §11.8 'Additional lane properties'. Identical to the v1.8+ branch enforced on hdmap:DomainSpecificationShape.||ositrace.shacl.ttl|
|ContentShape|ositrace|<a id="prop-https---w3id-org-ascs-ev-envited-x-ositrace-v6-levelofdetail"></a>levelOfDetail|||Covered object classes. ASAM OpenDRIVE e_objectType enumeration as defined in imports/OpenDrive/xsd_schema/OpenDRIVE_Object.xsd (ASAM OpenDRIVE V1.8.0) and specified in ASAM OpenDRIVE v1.9.0 §13 'Objects', plus 'truck' retained from the v1.4 object-type keywords. Identical to the enumeration enforced on hdmap:DomainSpecificationShape.||ositrace.shacl.ttl|
