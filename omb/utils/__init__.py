...
omb.validators.shacl) to discover required ontologies and SHACL
shapes based on RDF types in instance data.

Usage:
    from omb.utils import RegistryResolver
...
See also:
    - omb.validators.shacl: Main consumer of RegistryResolver
