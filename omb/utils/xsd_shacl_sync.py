...
USAGE:
======
    from omb.utils.xsd_shacl_sync import run_sync_check
...
STANDALONE TESTING:
==================
    python3 -m omb.utils.xsd_shacl_sync --test
    python3 -m omb.utils.xsd_shacl_sync --check  # Run actual sync check
...
def main() -> None:
    ...
    print("Usage: python3 -m omb.utils.xsd_shacl_sync [--test | --check]")
    sys.exit(1)
