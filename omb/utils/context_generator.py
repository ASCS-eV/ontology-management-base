...
======
    ...
    python -m omb.utils.context_generator --domain manifest
...
STANDALONE TESTING:
==================
    python -m omb.utils.context_generator --test
...
# Domains whose context is produced by an external LinkML pipeline rather than
# by this generator. They have no linkml/<domain>/<domain>.yaml in this repo,
# so they cannot be auto-detected from the source tree and must be listed here.
# "gx" is generated from the service-characteristics submodule by
# artifacts/gx/update-from-submodule.sh.
EXTERNAL_LINKML_DOMAINS = frozenset({"gx"})
...
from omb.utils.file_collector import write_if_changed  # noqa: E402
