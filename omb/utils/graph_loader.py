...
USAGE:
======
    from omb.utils.graph_loader import (
        load_graph,
        load_jsonld_files,
...
STANDALONE TESTING:
==================
    python3 -m omb.utils.graph_loader [--test] [--verbose] [files...]
...
def load_jsonld_files(
    ...
    for json_file in files:
        ...
        try:
            if context_url_map:
                from omb.utils.context_resolver import (
...
def _load_online_did_web_document(
    ...
    if context_url_map:
        from omb.utils.context_resolver import inline_jsonld_with_local_contexts
