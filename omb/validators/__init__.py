...
Key dependencies:
    - omb.utils.registry_resolver: Catalog-based path resolution
...
Usage:
    # Run all validators
    python -m omb.validators.validation_suite --run all --domain general

    # Run path-based conformance validator
    from omb.validators.conformance_validator import validate_data_conformance
